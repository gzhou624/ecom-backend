...
public class AddProductService extends JFrame implements ActionListener {
	private JPanel panel;
	private ViewProductService activity;
	...
	public AddProductService(ViewProductService prev, Employee employee) {
		super("Add Product");
	...
	public void actionPerformed(ActionEvent ae) {
		if (ae.getSource().equals(buttonLogout)) {
			...
			this.setVisible(false);
			new ViewProductService(new EmployeeService(employee.getUserId()), employee).setVisible(true);
		}

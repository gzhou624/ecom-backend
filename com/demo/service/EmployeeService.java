...
public class EmployeeService extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent ae) {
		if (ae.getSource().equals(buttonProfile)) {
			...
			new MyProfileService(this, employee).setVisible(true);
		}
			...
			this.setVisible(false);
			new ViewProductService(this, employee).setVisible(true);
		}
		else if (ae.getSource().equals(buttonViewCustomer)) {
			this.setVisible(false);
			new ViewCustomerService(this, employee).setVisible(true);
		}
		else if (ae.getSource().equals(buttonViewEmployee)) {
			this.setVisible(false);
			new ViewEmployeeService(this, employee).setVisible(true);
		}
		else {}
	}
}
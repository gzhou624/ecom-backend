...
public class CustomerService extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent ae) {
		if (ae.getSource().equals(buttonProfile)) {
			...
			new MyProfileService(this, customer).setVisible(true);
		}
			...
			this.setVisible(false);
			new ViewProductService(this, customer).setVisible(true);
		}
		else if (ae.getSource().equals(buttonMyProduct)) {
			this.setVisible(false);
			new MyProductService(this, customer).setVisible(true);
		}
		else {}
	}
}
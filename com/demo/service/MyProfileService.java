...
public class MyProfileService extends JFrame implements ActionListener {
	...
	public MyProfileService(JFrame activity, Customer customer) {
		super("My Profile");
	...
	public MyProfileService(JFrame activity, Employee employee) {
		super("My Profile");
	...
	public void actionPerformed(ActionEvent ae) {
		if (ae.getSource().equals(buttonBack)) {
			...
			new ChangePasswordService(this.usr).setVisible(true);
		}
